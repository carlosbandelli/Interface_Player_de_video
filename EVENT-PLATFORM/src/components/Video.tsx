          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              <img 
               ...
               src="https://github.com/carlosbandelli.png" alt=""
              />

              <div className="leading-relaxed">
                <strong className="font-bold text-2x1 block">Carlos Bandelli</strong>
                <span className="text-gray-200 text-sm block">CTO @BandelliusBrothers</span>
              </div>
            </div>
          </div>
